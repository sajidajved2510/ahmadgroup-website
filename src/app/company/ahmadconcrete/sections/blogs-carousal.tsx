...
type Blog = { id: string; title: string; thumbnail: {url: string}; publishDate?: Date; category?: string };

const BlogsCarousal = ({ blogs }: { blogs : Blog[] }) => {
    ...
    return (
        <Carousel className="w-full"
            ...
            <CarouselContent>
                {blogs.map((blog) => (
                    <CarouselItem key={blog.id} className='md:basis-1/2 lg:basis-1/3 pl-5'>
                        <div className="group cursor-pointer">
                            ...
                            <div className="relative">
                                ...
                                {/* blog meta */}
                                <div className="absolute -left-px -bottom-px bg-white z-20 py-2.5 px-4">
            ...
            <CarouselNext className="size-11 -top-[15%] lg:-top-[25%] max-lg:left-20 lg:right-0 border-[#0000004d] text-[#0000004d] hover:bg-[var(--secondary-color)] hover:border-[var(--secondary-color)] hover:text-white " />
            <CarouselPrevious className="size-11 -top-[15%] lg:-top-[25%] left-0 lg:right-[7%] lg:left-[unset] border-[#0000004d] text-[#0000004d] hover:bg-[var(--secondary-color)] hover:border-[var(--secondary-color)] hover:text-white " />
        </Carousel>
    )
}
