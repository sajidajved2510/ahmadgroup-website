...
const HomeFooter = () => {
    ...
    const menuCareerList = [
        ...
        {
            title: "factory employ",
            link: "/about#team"
        },
    ]
    return (
        <footer className='bg-black bg-[url(/images/footer-bg.png)] bg-linear-[180deg,#000000,#000000] bg-no-repeat bg-cover selection:text-white selection:bg-[var(--primary-color)]'>
            {/* footer wrapper */}
            <div>
                {/* footer top area */}
                <div className="border-b border-b-white/20 py-10">

                    <div className='w-full px-3 mx-auto sm:w-[90%] 2xl:max-w-[1410px] selection:text-white selection:bg-[var(--primary-color)]'>
                        <div className="grid grid-cols-12 items-center">
                            {/* footer-logo */}
                            <div className="col-span-12 md:col-span-3 mt-6 px-3 max-w-full cursor-pointer">
                                <Link href={routes.home}>
                                    <Image src="/images/logo-light.png" height={100} width={100} alt="Ahmadg Group logo" />
                                </Link>
                            </div>

                            <div className="col-span-12 md:col-span-5 md:col-start-4 flex md:justify-center mt-6 px-3">
                                <p className='text-white/70 leading-[28px] max-w-110 w-full'>Welcome to Ahmad Group, where quality meets innovation in a journey built on trust and excellence.</p>
                            </div>

                            {/* Established */}
                            <div className="col-span-12 md:col-span-4 md:col-start-9 justify-end mt-6 px-3">
                                <div>
                                    <h2 className='text-[var(--primary-color)]/40 font-semibold text-[40px] sm:text-[43px] lg:text-[50px] xl:text-[55px] leading-[1] uppercase underline'>EST . 1996</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* menu section */}
                <div className='w-full px-3 max-lg:pb-12.5 mx-auto sm:w-[90%] 2xl:max-w-[1410px]'>
                    <div className="grid grid-cols-12 items-center">
                        {/* location */}
                        <div className="col-span-12 lg:col-span-3 max-w-full px-3">
                            <div className="max-lg:border-none border-r border-r-white/20 py-12.5 lg:py-17.5">
                                {/* adress list */}
                                <ul className='lg:mb-17.5 max-lg:flex max-lg:items-center max-lg:flex-wrap max-lg:gap-12.5'>
                                    <li className='max-w-57.5 w-full lg:pb-10 relative lg:mb-11'>
                                        <span className='text-white text-sm underline block mb-5'>Head Office</span>
                                        <a href="https://www.google.com/maps" className='text-white/60 hover:cursor-pointer hover:text-[var(--primary-color)] text-[17px] leading-[28px] transition-all duration-300'>Multan, Pakistan Ahmad Tower, Bismillah Chowk Masoom Shah Road, Multan</a>
                                    </li>
                                    <li className='max-w-57.5 w-full relative'>
                                        <span className='text-white text-sm underline block mb-5'>Factory Address</span>
                                        <a href="https://www.google.com/maps" className='text-white/60 hover:cursor-pointer hover:text-[var(--primary-color)] text-[17px] leading-[28px] transition-all duration-300'>Sujan Pur road, Multan Pakistan</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        {/* menu container*/}
                        <div className="col-span-12 lg:col-span-9 lg:col-start-4 md:px-3">
                            <div className='grid grid-cols-1 min-[500px]:grid-cols-2 md:grid-cols-3'>
                                <div className="lg:mt-12 px-3 lg:justify-center flex">
                                    <div>
                                        {/*menu title */}
                                        <div className='mb-6'>
                                            <h5 className='text-white text-xl font-semibold relative pb-2.5'>
                                                <div className='absolute bottom-0 left-0 w-27 h-0.5 rounded-lg bg-linear-[90.01deg,rgba(255,255,255,.4)_.01%,rgba(255,255,255,0)_102.8%]' />
                                                COMPANY</h5>
                                        </div>
                                        ...
                                        <ul>
                                            {
                                                menuCompanyList.map((item, index) => (
                                                    <li key={index} className='group mb-6 leading-[1] relative transition-all duration-300'>
                                                        <a href={item.link} className='text-white/70 group-hover:text-[var(--primary-color)] text-[13px] font-semibold leading-[1.3] uppercase inline-flex items-center gap-2.5 transition-all duration-300'>
                                                            {item.title}
                                                            <svg className='fill-[var(--primary-color)] transition-all duration-300 opacity-0 group-hover:opacity-100' width="9" height="9" viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg"><path d="M0.0445549 0H9.00008V1.67647L1.69308 9L0 7.32353L4.99014 2.38235L0.0445549 2.42647V0Z"></path><path d="M9.0002 8.9996V3.35254L6.59424 5.73489V8.9996H9.0002Z"></path></svg>
                                                        </a>
                                                    </li>
                                                ))
                                            }
                                ...
                                <div className="max-[500px]:mt-5 lg:mt-12 px-3 lg:justify-center flex">
                                    <div>
                                        {/*menu title */}
                                        <div className='mb-6'>
                                            <h5 className='text-white text-xl font-semibold relative pb-2.5'>
            ...
            <div className='bg-white py-5'>
                <div className='w-full px-3 mx-auto sm:w-[90%] 2xl:max-w-[1410px]'>
                    <div className="flex max-md:flex-col-reverse max-md:flex-wrap max-md:gap-6 items-center justify-between">
                        <p className='text-[#00000099] text-sm font-light'>
                            Copyright 2025
                            <Link
                                href={routes.about}
                        ...
                        <ul className='flex items-center gap-7.5 text-[#00000099] text-xs'>
                            <li>
                                <a className='group flex items-center gap-1.5 transition-all hover:text-[var(--secondary-color)]' href="https://www.linkedin.com/">
                                    <svg className="fill-[#00000099] group-hover:fill-[var(--secondary-color)] size-3 transition-all" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 93.06 93.06" xmlSpace="preserve"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M11.185,0.08C5.004,0.08,0.001,5.092,0,11.259c0,6.173,5.003,11.184,11.186,11.184c6.166,0,11.176-5.011,11.176-11.184 C22.362,5.091,17.351,0.08,11.185,0.08z"></path> <rect x="1.538" y="30.926" width="19.287" height="62.054"></rect> <path d="M69.925,29.383c-9.382,0-15.673,5.144-18.248,10.022h-0.258v-8.479H32.921H32.92v62.053h19.27V62.281 c0-8.093,1.541-15.932,11.575-15.932c9.89,0,10.022,9.256,10.022,16.451v30.178H93.06V58.942 C93.06,42.235,89.455,29.383,69.925,29.383z"></path> </g> </g> </g></svg>
                                    LinkedIn</a>
                            </li>
                            <li>
                                <a className='group flex items-center gap-1.5 transition-all hover:text-[var(--secondary-color)]' href="https://www.facebook.com/">
                                    <svg className="fill-[#00000099] group-hover:fill-[var(--secondary-color)] size-4 transition-all" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Facebook</title><path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 26.805 26.805 0 0 0-.733-.009c-.707 0-1.259.096-1.675.309a1.686 1.686 0 0 0-.679.622c-.258.42-.374.995-.374 1.752v1.297h3.919l-.386 2.103-.287 1.564h-3.246v8.245C19.396 23.238 24 18.179 24 12.044c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.628 3.874 10.35 9.101 11.647Z" /></svg>
                                    Facebook</a>
                            </li>
                            <li>
                                <a className='group flex items-center gap-1.5 transition-all hover:text-[var(--secondary-color)]' href="https://www.instagram.com/">
                                    <svg className="fill-[#00000099] group-hover:fill-[var(--secondary-color)] size-4 transition-all" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>