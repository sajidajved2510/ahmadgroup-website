...
const HomeTestimonials = () => {
    ...
    return (
        <div className='w-full mb-20 lg:mb-25 xl:mb-30 pt-17.5 lg:pt-22.5 pb-35 lg:pb-45 xl:py-25 bg-[#e3e3e3] selection:bg-[var(--primary-color)] selection:text-white'>
            <div className='w-full px-3 mx-auto md:max-lg:max-w-[80%] lg:w-[95%] xl:w-[90%] 2xl:max-w-[1410px]'>
                <div className='grid grid-cols-12 justify-between items-center'>
                    <div className='col-span-12 lg:col-span-6 xl:col-span-5 sm:px-3 lg:mt-12'>
                        <div>
                            {/* section Title */}
                            <div>
                                <span className='text-[var(--secondary-color)] text-sm font-medium leading-[1] uppercase inline-block mb-2.5 relative'>
                                    ...
                                    Our client testimonial</span>
                                <h2 className='text-[32px] md:text-4xl lg:text-[45px] xl:text-[50px] 2xl:text-6xl font-medium'>Trusted by Stories of Success.</h2>
                                <p className='pt-6 md:pt-10 text-[#00000099] leading-[1.8]'>Ahmad Group has earned the trust of builders, contractors, and clients across Pakistan. Our commitment to quality, timely delivery, and customer satisfaction continues to define our reputation in the construction sector.</p>
                            </div>
                            {/* rating List */}
                            <ul className='mt-7.5 md:mt-17.5 flex items-center gap-5 flex-wrap'>
                                <li>
                                    <a href="https://share.google/ieAtMOlqsrk3wuuML" className='py-2 px-2.5 bg-[#00000099] rounded-lg block text-center'>
                                        <h6 className='text-white font-medium text-lg mb-2.5 leading-[1.4]'>4.7 Rating</h6>
                                        <div className='py-0.5 pl-[3px] pr-3 rounded-full border border-white/30 flex items-center gap-5'>
                                            <div className='py-[3px] px-1 rounded-full bg-[#1b2533] min-w-16 leading-[1]'>
                                                <Image
                                                    src="/images/clients-logo/google-logo.svg"
                                                    alt="Google"
                                                    loading='lazy'
                                                    decoding='async'
                                                    width={50}
                                            ...
                                            <span className='text-white font-medium text-xs leading-[1.5]'>Review On</span>
                                        </div>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div className='col-span-12 lg:col-span-6 lg:col-start-7 sm:px-3 max-lg:mt-12 '>
                        <Carousel className="w-full px-5 sm:px-6 md:px-7.5 xl:px-7.5 2xl:px-9 py-8 sm:py-11 md:py-15 xl:py-15 rounded-2xl mg:rounded-[30px] text-left bg-white"
                        ...
                        >
                            ...
                            <CarouselPrevious className="size-12 top-[calc(100%+2rem)] xl:top-1/2 translate-y-0 xl:-translate-y-10 left-1/4 sm:left-[30%] xl:left-full translate-x-9.5 border-[#0000004d] text-[#0000004d] bg-transparent hover:bg-[var(--secondary-color)] hover:border-[var(--secondary-color)] hover:text-white " />
                            <CarouselNext className="size-12 top-[calc(100%+2rem)] xl:top-1/2 translate-y-0 xl:translate-y-10 left-1/4 sm:left-[30%] xl:left-full max-xl:ml-20 translate-x-9.5  border-[#0000004d] text-[#0000004d] bg-transparent hover:bg-[var(--secondary-color)] hover:border-[var(--secondary-color)] hover:text-white " />
                        </Carousel>
                    </div>
                </div>
            </div>
